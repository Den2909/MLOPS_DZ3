...
with DAG(
    dag_id='forecast_electricity_consumption',
    default_args=args,
    ...
    train_test_split_data = BashOperator(task_id='train_test_split_data',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ3/MLOPS_DZ3/scripts/train_test_split_data.py",
                            dag=dag)  
    train_model = BashOperator(task_id='train_model',
                            bash_command="python3 /home/den/Projects/MLOPS_DZ3/MLOPS_DZ3/scripts/train_model.py",
                            dag=dag)
